...
<main> 
	<section class="favourites">
        ...
        <div class="favourites__items">    <?= get_user_favorites_list($include_links, $filters, $include_button, $include_thumbnails = true, $thumbnail_size = 'thumbnail', $include_excerpt = true); ?>
        </div>        
        <div class="registration__callback">
            <label class="favourites-btn_news btn_news" for="modal-1" 
                   data-title-service=""
            >
                Заказать установку
            </label>
        </div>
        <div class="favourites__clear">
            <?= get_clear_favorites_button($site_id, "Очистить избранное"); ?>
        </div>
	</section>
