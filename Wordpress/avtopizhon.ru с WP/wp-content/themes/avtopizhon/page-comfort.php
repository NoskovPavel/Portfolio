...
<main> 
	<section class="comfort anchor""> 
		<h2 class="section-title">Комфорт</h2>
		<section class="comfort__sound-insutation">			
			<h2 class="section-title-small">Шумоизоляция</h2>
				<?php $catquery = new WP_Query( array( 'category__and' => array(2,22) )); ?>
				...
				<div class="product-items__more">
					<a href="<?php echo get_category_link(2); ?>">Вся шумоизоляция...</a>
				</div>			
		</section>			
		<section class="comfort__tint">
			<h2 class="section-title-small">Тонировка</h2>
			<?php $catquery = new WP_Query( array( 'category__and' => array(9,22) )); ?>
				<div class="product-items">
					<?php while($catquery->have_posts()) : $catquery->the_post(); ?>
						<div class="product-items__item">
							<a href="<?php the_permalink() ?>">
				...
				<?php wp_reset_postdata();?>
				<div class="product-items__more">
					<a href="<?php echo get_category_link(9); ?>">Вся тонировка...</a>
				</div>
		</section>
		<section class="comfort__braid">
			<h2 class="section-title-small">Оплетка руля</h2>
			<?php $catquery = new WP_Query( array( 'category__and' => array(10,22) )); ?>
			<div class="product-items">
				<?php while($catquery->have_posts()) : $catquery->the_post(); ?>
					<div class="product-items__item">
						<a href="<?php the_permalink() ?>">
			...
			<?php wp_reset_postdata();?>
			<div class="product-items__more">
				<a href="<?php echo get_category_link(10); ?>">Вся оплетка руля...</a>
			</div>
		</section>
	</section>	
